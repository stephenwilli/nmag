...
add_action( 'tgmpa_register', 'simplemag_register_required_plugins' );
 ...
 */
function simplemag_register_required_plugins() {
	/*
	...
	$plugins = array(
        ...
        array(
            'name'               => 'Shortcodes Indep',
            'slug'               => 'shortcodes-indep',
            'source'             => get_stylesheet_directory() . '/admin/tgm/plugins/shortcodes-indep.zip',
            'required'           => false,
        ),
