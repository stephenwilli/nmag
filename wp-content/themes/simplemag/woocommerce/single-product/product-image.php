...
<div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>" data-columns="<?php echo esc_attr( $columns ); ?>" style="opacity: 0; transition: opacity .25s ease-in-out;">
	<figure class="<?php echo esc_attr( $product_page_image_class ); ?> woocommerce-product-gallery__wrapper">
		<?php
		$attributes = array(
	...
	<?php
	// Thumbs
	if ( $ti_option['smwc_product_page_slider'] == 'images_slider' ) :
    	$product_page_image_class = "global-sliders product-page-slider";
	?>
