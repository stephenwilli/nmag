...
if( !function_exists( 'shortcode_authors' )) {
	function shortcode_authors( $atts, $content = null ) {
        ...
        $output .= '<ul class="sc-authors clearfix">';
	        ...
	        foreach ( $site_authors as $author ):
		        ...
		        $output .= '<li>';
		        	$output .= '<div class="author-avatar"><a href="'.get_author_posts_url( $author_id ) . '">' . $author_avatar . '</a></div>';
...
if( !function_exists( 'shortcode_button' )) {
	function shortcode_button( $atts, $content = null ) {
		...
		return '<a href="' . $url . '" class="sc-button bg-' . $color . ' color-' . $text . '" target="' . $openin . '">
			   		<span>' . $content . '</span>
			    </a>';
	}
